...
class Label(pygame.sprite.Sprite):
    ...
    """
    def __init__(self, FgColor, BgColor, Loc, Invs = False, Font = 'meera'):
...
dayLabel = Label( ((0x00, 0x00, 0x00)),((0xFF, 0xF1,0x93)),(50,60))
dayLabel.text = "Day {0}".format(nextdayupdate.day)
dayLabel.update()
